import { contact as c, CALENDLY_URL } from '../data/content'
  ...
  return (
    <section id="contact" className="relative border-b border-edge">
      ...
      <div className="relative mx-auto max-w-5xl px-5 py-24 text-center">
        <h2 className="text-3xl font-semibold tracking-tight text-slate-50 sm:text-4xl">{c.title}</h2>
        <p className="mx-auto mt-5 max-w-2xl text-lg leading-relaxed text-slate-400">{c.body}</p>
        <a
          href={CALENDLY_URL}
          target="_blank"
          rel="noreferrer"
